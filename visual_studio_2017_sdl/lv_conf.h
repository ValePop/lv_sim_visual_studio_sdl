/**
 * @file lv_conf.h
 * Configuration file for LVGL v7.6.0
 */
...
#define LV_USE_USER_DATA_FREE 0 //commento mio: purtroppo sembra che ancora non ci sia una risoluzione all'user data che rimane anche dopo che il suo oggetto viene cancellato, creando un memory leak
